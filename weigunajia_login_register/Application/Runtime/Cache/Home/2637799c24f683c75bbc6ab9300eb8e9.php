...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/weiguanjia/Public/Home/css/log_reg.css" />
    </head>
    <body>
        <!--navbar-->
        <!--navbar-->
    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="container main_content">
            <div class="row clearfix">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 column">
                        <form role="form" action="/weiguanjia/Home/UserManager/register" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <img class="verify_img" src="/weiguanjia/Home/UserManager/getVerify"/>
                            </div>
                            <div class="form-group">
                                <div class="checkbox">
